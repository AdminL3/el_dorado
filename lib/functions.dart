...
class Functions {
  ...
  static Future<bool> checkVorne(int cardid) async {
    ...
    final firebaseShop = await FirebaseFirestore.instance
        ...
        .doc('AnzahlVorne')
        .get();
    final firebasecard = await FirebaseFirestore.instance
        .collection('Shop')
        .doc(x)
        .get();
  ...
  static buy_Shop(int cardid) async {
    String x = '$cardid';
    //set firebase
    ...
    //get firebase
    final firebasegetCard =
    await FirebaseFirestore.instance.collection('Shop').doc(x).get();
    final firebasegetShop =
    await FirebaseFirestore.instance.collection('Shop').doc('AnzahlVorne').get();
  ...
  static String getImagePathById(int id) {
    ...
    if (id >= 0 && id < imageNames.length) {
      return 'lib/images/${imageNames[id]}.png';
    } else {
      debugPrint('Couldnt load Image');
      return 'lib/images/X.png';
    }
  }
}